  ...
  return (
    <div className="flex h-screen bg-gradient-to-b from-gray-900 to-black">
      ...
      <main className="flex-1 overflow-y-auto pb-24">
        <PlaylistHeader playlist={playlist} songCount={songs.length} isOwner={playlist.user_id === user.user.id} />
        ...
        <div className="p-6">
          {songs.length > 0 ? (
            ...
            <div className="text-center py-12">
              <h3 className="text-xl text-white mb-2">This playlist is empty</h3>
