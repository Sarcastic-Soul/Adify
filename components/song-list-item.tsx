...
export function SongListItem({ song, queue = [], index, showCover = true, showAlbum = true }: SongListItemProps) {
    ...
    <div className="group flex items-center gap-4 p-2 rounded-md hover:bg-gray-800/50 transition-colors">
      ...
      {showAlbum && (
        <div className="hidden md:block flex-1 min-w-0">
          <p className="text-gray-400 text-sm truncate">{song.album?.title || "Single"}</p>
        </div>
      )}
